...
<c:forEach var="article" items="${cartlist}">
    <c:set var="total" value="${total + article.total}"/>
</c:forEach>
...
<form class="form-signin" action="checkout.bhukkad" method="post" style="float:right">
<h3>Grand Total:</h3>
<input type="text" name="gtotal" value="${total}" readonly="readonly">
<br>
<br>
<textarea class="form-control" placeholder="Enter delivery address" name="address" required></textarea>
<br>
<input type="number"  id="phn" class="form-control" placeholder="Phone number" name="phone" maxlength="10" required>
<br>
<br>
